<html>
	...
	<body  style='width:100%;height:100%'>
	    ...
	    <input type="hidden" id="referer" value="<%=request.getParameter("referer")%>"/>
	     <input type="hidden" id="setter" value="<%=request.getParameter("setter")%>"/>
		<script type="text/javascript" charset="utf-8">
		 ...
		 var referer=document.getElementById("referer").value; //emailcontactid
