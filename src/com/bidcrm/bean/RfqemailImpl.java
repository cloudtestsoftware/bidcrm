	 ...
	 * @author S.K Jana Version 1.0 
	 ...
	 public class RfqemailImpl extends QueryImpl implements QueryEvent {
		...
		public  boolean  doInsert(){
			...
			if(!tu.isEmptyValue(this.getMainxml())){
					sql=query.makeBulkSQL(true,this.getMainxml(),"RFQEmail2RFQ",(QueryImpl)this);
			...
			if(sql==null){
				...
				setParentobjid(query.getObjId()); 
				 if(!tu.isEmptyValue(this.getEmaildocsxml()) ){
					 sql+=query.makeBulkSQL(false,getEmaildocsxml(),"EmailDocs2RFQEmail",(QueryImpl)this);
