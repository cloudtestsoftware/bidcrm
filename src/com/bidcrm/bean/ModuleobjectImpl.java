	 ...
	 * @author S.K Jana Version 1.0 
	 ...
	 public class ModuleobjectImpl extends QueryImpl implements QueryEvent {
			...
			if(sql==null){
				...
				setParentobjid(query.getObjId()); 
				 if(!tu.isEmptyValue(this.getObjectprivilegexml()) ){
					 sql+=query.makeBulkSQL(false,getObjectprivilegexml(),"ObjectPrivilege2ModuleObject",(QueryImpl)this);
