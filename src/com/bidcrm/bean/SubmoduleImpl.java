	 ...
	 * @author S.K Jana Version 1.0 
	 ...
	 public class SubmoduleImpl extends QueryImpl implements QueryEvent {
		...
		public  boolean  doInsert(){
			...
			if(!tu.isEmptyValue(this.getMainxml())){
					sql=query.makeBulkSQL(true,this.getMainxml(),"SubModule2Module",(QueryImpl)this);
			...
			if(sql==null){
				...
				setParentobjid(query.getObjId()); 
				 if(!tu.isEmptyValue(this.getModuleobjectxml()) ){
					 sql+=query.makeBulkSQL(false,getModuleobjectxml(),"ModuleObject2SubModule",(QueryImpl)this);
