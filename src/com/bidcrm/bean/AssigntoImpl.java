	 ...
	 * @author S.K Jana Version 1.0 
	 ...
	 public class AssigntoImpl extends QueryImpl implements QueryEvent {
		 protected static Log logger = LogFactory.getLog(AssigntoImpl.class); 
 

		 public String AssigntoFilter="";

		 public String assigntoAccessFilter="";
		...
		public  boolean   doDelete(String[] childtabs){
			...
			String sql=query.removeSql("Assignto",this.getParentobjid(),childtabs,groupuser);
