	...
	public class ObjectDao extends ObjectImpl {
		...
		protected String [] maindatadomain={"Raw_t","Raw_t","Name_t","Type_t","Type_t","String300_t"};
	...
	protected String [] propObjectlist={"entityaccesstype","useraccesstype"};
		...
		protected String [] attributedatadomain={"Raw_t","Name_t","Name_t","Type_t"};
		...
		protected String [] helpdatadomain={"Raw_t","Name_t","String4000_t","Int_t"};
		...
		protected String [] objectrulecol={"objid","name","tablename","effectedtable","description","reason","actionstate","condition","ruleindex","status"};
		protected String [] objectrulecolcaption={"Id","Rule Name","Table Name","Effected Table","Description","Reason","Action State","Condition ($)","Rule Index","Status"};
		protected String [] objectrulesqldatatype={DataType.VARCHAR,DataType.VARCHAR,DataType.VARCHAR,DataType.VARCHAR,DataType.VARCHAR,DataType.VARCHAR,DataType.VARCHAR,DataType.VARCHAR,DataType.INTEGER,DataType.VARCHAR};
		protected String [] objectruledatadomain={"Raw_t","Name_t","Name_t","Name_t","String4000_t","Type_t","Type_t","String500_t","Int_t","Status_t"};
		protected String [] objectruledisable={"yes,no,no,no,no,no,no,no,no,no"};
		protected String [] objectrulecolsearch={"#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#select_filter,#select_filter,#text_filter,#text_filter,#text_filter"};
		...
		public Rows getAttributeRows(){
			TemplateTable tab=this.doSelectChild("attribute", "attribute2object",this.getParentobjid(),attributecol,attributesqldatatype,this.AttributeFilter,attributeAccessFilter);
			String [] propAttributelist={"hasproperty"};
			String [] codeAttributelist={};
			String [] relationAttributelist={};
			Rows rows=tu.getXMLRows(tab, "attribute",codeAttributelist,propAttributelist,relationAttributelist,attributecolcaption,attributedatadomain,(QueryImpl)this);
		...
		public Rows getHelpRows(){
			TemplateTable tab=this.doSelectChild("help", "help2object",this.getParentobjid(),helpcol,helpsqldatatype,this.HelpFilter,helpAccessFilter);
			String [] propHelplist={};
			String [] codeHelplist={};
			String [] relationHelplist={};
			Rows rows=tu.getXMLRows(tab, "help",codeHelplist,propHelplist,relationHelplist,helpcolcaption,helpdatadomain,(QueryImpl)this);
			ArrayList<Userdata> userdata=rows.getUserdata();
		...
		public Rows getObjectruleRows(){
			TemplateTable tab=this.doSelectChild("objectrule", "objectrule2object",this.getParentobjid(),objectrulecol,objectrulesqldatatype,this.ObjectruleFilter,objectruleAccessFilter);
			String [] propObjectrulelist={"reason","actionstate","status"};
			String [] codeObjectrulelist={};
			String [] relationObjectrulelist={};
			Rows rows=tu.getXMLRows(tab, "objectrule",codeObjectrulelist,propObjectrulelist,relationObjectrulelist,objectrulecolcaption,objectruledatadomain,(QueryImpl)this);
			ArrayList<Userdata> userdata=rows.getUserdata();
		...
		public Rows getObjectSummaryRows(){
			TemplateTable tab=this.doSelect(summarycol,summarysqldatatype,this.ObjectFilter,false,objectAccessFilter);
		...
		public Items getObjectForm(){
			TemplateTable tab=this.doSelect(maincol,mainsqldatatype,this.ObjectFilter,true,objectAccessFilter);
			Items items=tu.getXMLForm(tab, "Object",codeObjectlist,propObjectlist,relationObjectlist,maincolcaption,maindatadomain,mainformfields,(QueryImpl)this);
			return items;
		}

		public Rows getObjectRows(){
			TemplateTable tab=this.doSelect(maincol,mainsqldatatype,null,false,objectAccessFilter);
			Rows rows=tu.getXMLRows(tab, "Object",codeObjectlist,propObjectlist,relationObjectlist,maincolcaption,maindatadomain,(QueryImpl)this);
			ArrayList<Userdata> userdata=rows.getUserdata();
		...
		public Rows getObjectRowModified(){
			Rows rows=tu.getXMLRows(maindata, "Object",codeObjectlist,propObjectlist,relationObjectlist,maincolcaption,maindatadomain,(QueryImpl)this);
			return rows;
		}
		...
		public boolean postObjectContainer() throws DaoException{
		...
		public Rows getObjectByFilter(){
			...
			if(!tu.isEmptyValue(this.getFilters()) &&this.getFilters().toLowerCase().indexOf("object2")<0){
			...
			Rows rows=tu.getXMLFilterRows(tab, "Object",codeObjectlist,propObjectlist,relationObjectlist,maincol,maincolcaption,maindatadomain,(QueryImpl)this);
			ArrayList<Userdata> userdata=rows.getUserdata();
			Userdata data1= new Userdata("tabs",Arrays.asList(childtabs));
			Userdata data2= new Userdata("tabnames",Arrays.asList(childtabnames));
			Userdata data3= new Userdata("filters",Arrays.asList(maincolsearch));
		 ...
		 public JSONObject getObjectRecordCount() throws JSONException{
			String newfilter=" groupuser='"+this.getGroupuser()+"'";
			if(!tu.isEmptyValue(this.getFilters()) &&this.getFilters().toLowerCase().indexOf("object2")<0){
				newfilter+=" and object2"+this.getFilters();
			}else{
