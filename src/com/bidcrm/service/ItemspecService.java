		...
		import com.bidcrm.dao.ItemspecDao;
		/*
		*  URL Parameters:
		*  
		...
		*/
		...
		public class ItemspecService {
			...
			public Items getItemspecForm() {
				Items items = null;
				try {
					items=new ItemspecDao(uriInfo,header).getItemspecForm();
				} catch (AuthenticationException e) {
			...
			// Get record count with filter for Itemspec
			@GET
			@Path("/recordcount")
			@Produces({"application/json"})
			public Response getItemspecRecordCount() throws JSONException {
				JSONObject rows = new JSONObject();
				try {
					rows=new ItemspecDao(uriInfo,header).getItemspecRecordCount();
				} catch (AuthenticationException e) {
