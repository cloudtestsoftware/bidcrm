		...
		import com.bidcrm.dao.PotasksDao;
		/*
		*  URL Parameters:
		*  
		...
		*/
		...
		public class PotasksService {
			...
			public Items getPotasksForm() {
				Items items = null;
				try {
					items=new PotasksDao(uriInfo,header).getPotasksForm();
				} catch (AuthenticationException e) {
			...
			// Get record count with filter for Potasks
			@GET
			@Path("/recordcount")
			@Produces({"application/json"})
			public Response getPotasksRecordCount() throws JSONException {
				JSONObject rows = new JSONObject();
				try {
					rows=new PotasksDao(uriInfo,header).getPotasksRecordCount();
				} catch (AuthenticationException e) {
