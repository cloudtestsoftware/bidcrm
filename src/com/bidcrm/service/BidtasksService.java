		...
		import com.bidcrm.dao.BidtasksDao;
		/*
		*  URL Parameters:
		*  
		...
		*/
		...
		public class BidtasksService {
			...
			public Items getBidtasksForm() {
				Items items = null;
				try {
					items=new BidtasksDao(uriInfo,header).getBidtasksForm();
				} catch (AuthenticationException e) {
			...
			// Get record count with filter for Bidtasks
			@GET
			@Path("/recordcount")
			@Produces({"application/json"})
			public Response getBidtasksRecordCount() throws JSONException {
				JSONObject rows = new JSONObject();
				try {
					rows=new BidtasksDao(uriInfo,header).getBidtasksRecordCount();
				} catch (AuthenticationException e) {
