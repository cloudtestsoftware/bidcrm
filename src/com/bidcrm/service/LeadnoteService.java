		...
		import com.bidcrm.dao.LeadnoteDao;
		/*
		*  URL Parameters:
		*  
		...
		*/
		...
		public class LeadnoteService {
			...
			// Get record count with filter for Leadnote
			@GET
			@Path("/recordcount")
			@Produces({"application/json"})
			public Response getLeadnoteRecordCount() throws JSONException {
				JSONObject rows = new JSONObject();
				try {
					rows=new LeadnoteDao(uriInfo,header).getLeadnoteRecordCount();
				} catch (AuthenticationException e) {
