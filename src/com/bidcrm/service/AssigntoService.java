		...
		import com.bidcrm.dao.AssigntoDao;
		/*
		*  URL Parameters:
		*  
		...
		*/
		...
		public class AssigntoService {
			...
			// Get record count with filter for Assignto
			@GET
			@Path("/recordcount")
			@Produces({"application/json"})
			public Response getAssigntoRecordCount() throws JSONException {
				JSONObject rows = new JSONObject();
				try {
					rows=new AssigntoDao(uriInfo,header).getAssigntoRecordCount();
				} catch (AuthenticationException e) {
