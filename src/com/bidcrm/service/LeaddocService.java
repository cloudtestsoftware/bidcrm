		...
		import com.bidcrm.dao.LeaddocDao;
		/*
		*  URL Parameters:
		*  
		...
		*/
		...
		public class LeaddocService {
			...
			// Get record count with filter for Leaddoc
			@GET
			@Path("/recordcount")
			@Produces({"application/json"})
			public Response getLeaddocRecordCount() throws JSONException {
				JSONObject rows = new JSONObject();
				try {
					rows=new LeaddocDao(uriInfo,header).getLeaddocRecordCount();
				} catch (AuthenticationException e) {
