		...
		import com.bidcrm.dao.ContactDao;
		/*
		*  URL Parameters:
		*  
		...
		*/
		...
		public class ContactService {
			...
			// Get record count with filter for Contact
			@GET
			@Path("/recordcount")
			@Produces({"application/json"})
			public Response getContactRecordCount() throws JSONException {
				JSONObject rows = new JSONObject();
				try {
					rows=new ContactDao(uriInfo,header).getContactRecordCount();
				} catch (AuthenticationException e) {
