		...
		import com.bidcrm.dao.SupplierDao;
		/*
		*  URL Parameters:
		*  
		...
		*/
		...
		public class SupplierService {
			...
			public Items getSupplierForm() {
				Items items = null;
				try {
					items=new SupplierDao(uriInfo,header).getSupplierForm();
				} catch (AuthenticationException e) {
			...
			// Get record count with filter for Supplier
			@GET
			@Path("/recordcount")
			@Produces({"application/json"})
			public Response getSupplierRecordCount() throws JSONException {
				JSONObject rows = new JSONObject();
				try {
					rows=new SupplierDao(uriInfo,header).getSupplierRecordCount();
				} catch (AuthenticationException e) {
